...
import fr.azures.mod.greenportals.registry.items.SavePointDevice;
...
public class ModItems {
	...
	public static final RegistryObject<Item> SAVE_POINT_DEVICE = ITEMS.register("save_point_device", () -> new SavePointDevice(new Item.Properties()));
