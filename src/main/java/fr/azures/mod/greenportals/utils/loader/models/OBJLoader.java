/*
  ...
  **********************************************************************************************************************************
*/
package fr.azures.mod.greenportals.utils.loader.models;
    ...
    public static void render(OBJModel model) {
        ...
        GL32.glBegin(GL_TRIANGLES);
        {
            for (OBJModel.Face face : model.getFaces()) {
                ...
                {
                    GL32.glNormal3f(normals[0].x(), normals[0].y(), normals[0].z());
                    GL32.glTexCoord2f(texCoords[0].x, texCoords[0].y);
                    GL32.glVertex3f(vertices[0].x(), vertices[0].y(), vertices[0].z());
                    GL32.glNormal3f(normals[1].x(), normals[1].y(), normals[1].z());
                    GL32.glTexCoord2f(texCoords[1].x, texCoords[1].y);
                    GL32.glVertex3f(vertices[1].x(), vertices[1].y(), vertices[1].z());
                    GL32.glNormal3f(normals[2].x(), normals[2].y(), normals[2].z());
                    GL32.glTexCoord2f(texCoords[2].x, texCoords[2].y);
                    GL32.glVertex3f(vertices[2].x(), vertices[2].y(), vertices[2].z());
                }
            }
        }
        GL32.glEnd();
