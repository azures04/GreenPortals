package fr.azures.mod.greenportals.utils.loader.textures;
...
public class Texture extends net.minecraft.client.renderer.texture.Texture {
	...
	public void bindTexture() {
		...
		RenderSystem.activeTexture(this.id);
		//;(this.id, resourceLocation);
		GlStateManager._bindTexture(getId());
		//GameRenderer.getPositionTexColorShader();
		Minecraft.getInstance().getTextureAtlas(new ResourceLocation("textures/atlas/blocks.png")).apply(resourceLocation);
	}
